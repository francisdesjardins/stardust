const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/counter.story-NU0jhI2x.js',
      'assets/index-CHDL1A9q.js',
      'assets/context-injection.story-BnQQNcyC.js',
      'assets/equals.story-Dus6aLnz.js',
      'assets/initial.story-BS75kf53.js',
      'assets/two-providers.story-DYYazTh1.js',
      'assets/use-store-context.story-wEYFm3e8.js',
      'assets/use-store.story-BgxeteW3.js',
      'assets/use-suspense-store.story-y8ZHq24o.js',
    ])
) => i.map((i) => d[i]);
true &&
  (function polyfill() {
...
function requireScheduler_production() {
  ...
  (function (exports$1) {
    ...
    function shouldYieldToHost() {
      return needsPaint ? !0 : exports$1.unstable_now() - startTime < frameInterval ? !1 : !0;
    }
...
function requireReactDomClient_production() {
  ...
  for (
    ...
    var eventName$jscomp$inline_1578 = simpleEventPluginEvents[i$jscomp$inline_1577],
      domEventName$jscomp$inline_1579 = eventName$jscomp$inline_1578.toLowerCase(),
  ...
  if ('19.2.5' !== isomorphicReactPackageVersion$jscomp$inline_1840)
    throw Error(
      formatProdErrorMessage(527, isomorphicReactPackageVersion$jscomp$inline_1840, '19.2.5')
    );
...
function __pwRender(value) {
  return window.__pwTransformObject(value, (v) => {
    if (isJsxComponent(v)) {
      ...
      if (isJsxFragment(type)) type = __pwReact.Fragment;
...
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___create_store_context_counter_story_CounterContextHarness =
  () =>
    __vitePreload(
      () => import('./counter.story-NU0jhI2x.js'),
      true ? __vite__mapDeps([0, 1]) : void 0
    ).then((mod) => mod.CounterContextHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___create_store_context_context_injection_story_PricingContextHarness =
  () =>
    __vitePreload(
      () => import('./context-injection.story-BnQQNcyC.js'),
      true ? __vite__mapDeps([2, 1]) : void 0
    ).then((mod) => mod.PricingContextHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___create_store_context_equals_story_EqualsContextHarness =
  () =>
    __vitePreload(
      () => import('./equals.story-Dus6aLnz.js'),
      true ? __vite__mapDeps([3, 1]) : void 0
    ).then((mod) => mod.EqualsContextHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___create_store_context_initial_story_CounterWithInitialHarness =
  () =>
    __vitePreload(
      () => import('./initial.story-BS75kf53.js'),
      true ? __vite__mapDeps([4, 1]) : void 0
    ).then((mod) => mod.CounterWithInitialHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___create_store_context_two_providers_story_TwoProvidersHarness =
  () =>
    __vitePreload(
      () => import('./two-providers.story-DYYazTh1.js'),
      true ? __vite__mapDeps([5, 1]) : void 0
    ).then((mod) => mod.TwoProvidersHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_context_story_ContextHarness =
  () =>
    __vitePreload(
      () => import('./use-store-context.story-wEYFm3e8.js'),
      true ? __vite__mapDeps([6, 1]) : void 0
    ).then((mod) => mod.ContextHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_context_story_ContextWithSelectorHarness =
  () =>
    __vitePreload(
      () => import('./use-store-context.story-wEYFm3e8.js'),
      true ? __vite__mapDeps([6, 1]) : void 0
    ).then((mod) => mod.ContextWithSelectorHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_DerivedEqualityHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.DerivedEqualityHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_DerivedMultiHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.DerivedMultiHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_DerivedSingleHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.DerivedSingleHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_EqualsHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.EqualsHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_FullSnapshotHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.FullSnapshotHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_MultiSliceHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.MultiSliceHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_ProduceHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.ProduceHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_store_story_SelectorHarness =
  () =>
    __vitePreload(
      () => import('./use-store.story-BgxeteW3.js'),
      true ? __vite__mapDeps([7, 1]) : void 0
    ).then((mod) => mod.SelectorHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_suspense_store_story_ContextHarness =
  () =>
    __vitePreload(
      () => import('./use-suspense-store.story-y8ZHq24o.js'),
      true ? __vite__mapDeps([8, 1]) : void 0
    ).then((mod) => mod.ContextHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_suspense_store_story_FulfilledHarness =
  () =>
    __vitePreload(
      () => import('./use-suspense-store.story-y8ZHq24o.js'),
      true ? __vite__mapDeps([8, 1]) : void 0
    ).then((mod) => mod.FulfilledHarness);
const D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___use_suspense_store_story_RejectedHarness =
  () =>
    __vitePreload(
      () => import('./use-suspense-store.story-y8ZHq24o.js'),
      true ? __vite__mapDeps([8, 1]) : void 0
    ).then((mod) => mod.RejectedHarness);
__pwRegistry.initialize({
  D__workspace_francisdesjardins_2025_stardust_packages_react_src___tests___create_store_context_counter_story_CounterContextHarness,
