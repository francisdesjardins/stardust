import { a as createStore, u as useStore, j as jsxRuntimeExports } from './index-CHDL1A9q.js';
import './index-C2HjpCzT.js';

function makePricingStore() {
  return createStore({ basePrice: 100 }, ({ get, getContext }) => ({
    getTotal() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
        'data-testid': 'base',
        children: snap.basePrice,
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
        'data-testid': 'total',
        children: contextStore.getTotal(),
      }),
...
function ContextWithSelectorHarness() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
        'data-testid': 'total',
        children: selectorContextStore.getTotal(),
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx('button', {
        onClick: () => {
...
//# sourceMappingURL=use-store-context.story-wEYFm3e8.js.map
